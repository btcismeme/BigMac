...
| RDW             | SpaceX IPO proxy / space-tech rotation | 2026-05-18               | **active** / pending                             | Pre-IPO sector proxy rotation: accumulate high-beta supplier, use equity + leverage + LEAPS (not spreads), redeemable share arb is soft ceiling if mega-IPO demand hot                                                                          | `rdw-2026-05.md`  |
